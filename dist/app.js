...
app.get('/image', [validator_1.validationInputs, image_cache_1.imageCache], async (req, res) => {
    ...
    return res
        .status(400)
        .send('fail to process image, please check the name of the file and that is on the images folder');
});
app.listen(PORT, () => {
