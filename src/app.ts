...
app.get('/image', imageCache, async (req: express.Request, res: express.Response) => {
  ...
  return res
    .status(400)
    .send(
      'fail to process image, please check the name of the file and the values of width and height',
    );
});
